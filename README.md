...
| Interactive visualization tools | `app/` — the Rejuvenation Explorer (Streamlit) |
...
├── app/                     # Rejuvenation Explorer (Streamlit)
...
The **Rejuvenation Explorer** lets collaborators browse UMAPs, epigenetic-age-by-treatment plots, trajectory flows, and SASP heatmaps without touching code.
